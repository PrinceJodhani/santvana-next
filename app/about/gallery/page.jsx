...
const galleryCategories = [
  {
    ...
    description:
      "Community outreach, mental health awareness camps, school workshops, and accessible counselling support.",
    icon: (
    ...
    bgGradient: "from-brown-50 to-teal-50",
    iconBg: "bg-gradient-to-br from-brown-100 to-brown-200",
  ...
  },
  {
    ...
    description:
      "Hands-on clinical training for psychology students under professional supervision.",
    icon: (
      <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" />
      </svg>
    ),
    bgGradient: "from-teal-50 to-brown-50",
  ...
  },
  {
    ...
    bgGradient: "from-brown-50 to-brown-100/50",
    iconBg: "bg-brown-100",
    iconColor: "text-brown-700",
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center mb-14">
            <h2 className="text-2xl md:text-3xl font-serif font-bold text-brown-900 mb-4">
          ...
          >
            {galleryCategories.map((category) => (
              <motion.div
                ...
                className={`group relative bg-gradient-to-br ${category.bgGradient} border ${category.borderColor} rounded-2xl overflow-hidden hover:shadow-lg hover:shadow-brown-100/30 transition-all duration-500`}
              >
          ...
          >
            <div className="bg-brown-50/60 border border-brown-100 rounded-2xl p-6">
